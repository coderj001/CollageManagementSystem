...
urlpatterns = [
    ...
    path(
        "delete_session/<session_id>/", HodViews.delete_session, name="delete_session"
    ),
    ...
    path(
        "delete_student/<student_id>/", HodViews.delete_student, name="delete_student"
    ),
    ...
    path(
        "delete_subject/<subject_id>/", HodViews.delete_subject, name="delete_subject"
    ),
    ...
    path(
        "staff_leave_approve/<leave_id>/",
        HodViews.staff_leave_approve,
        name="staff_leave_approve",
    ),
    path(
        "staff_leave_reject/<leave_id>/",
